angular.module('starter.controllers', ['ngTable'])
    .controller('AppCtrl', function ($rootScope,$scope, $ionicModal, $timeout, $http, $interval, NgTableParams, $location, $cordovaLocalNotification) {
        ...
        $scope.getSocketUrl = function(){
            $http.get('http://47.94.203.104:8000/ext/channel.php')//('http://47.94.203.104:8000/ext/channel.php')
        ...
        $scope.getTing = function(){
            $http.get('http://47.94.203.104:8000/daily/ting20.php')
            .success(function(data){
                $scope.ting=data;
            });
        };
        ...
        $scope.addAttend = function(code){
            ...
            var urlAdd = "http://47.94.203.104:8000/attend.php?a=a&c=" + code;
            $http.get(urlAdd)
                .success(function (data) {
        ...
        $scope.deleteAttend = function(code){
            var urlDetete = "http://47.94.203.104:8000/attend.php?a=d&c=" + code;
            $http.get(urlDetete)
                .success(function (data) {
                    $scope.getCounter($scope.url);
                });
        ...
        $scope.openModal = function (code) {
            ...
            if(code=='sz399001'){
                var url = 'http://47.94.203.104:8000/prefindex.php?code=' + code;
            }else{
                var url = 'http://47.94.203.104:8000/prefprice.php?code=' + code
            }
    ...
    .controller('CalCtrl', function ($rootScope,$scope, $http, $ionicModal,$cordovaLocalNotification, NgTableParams) {
        ...
        function calindex(n) {
            $http.get('http://47.94.203.104:8000/calindex.php?n=' + n)
                .success(function (data) {
                    console.log(data);
                    createChart(data);
                });
    ...
    .controller('ActionCtrl', function ($rootScope,$scope, $http, $ionicModal, NgTableParams) {
        ...
        $scope.url = "http://47.94.203.104:8000/actionList.php";
    ...
    .controller('ShortCtrl', function ($rootScope,$scope, $http, $ionicModal, NgTableParams, $location) {
        ...
        $scope.loadShort = function(id){
            $scope.url = "http://47.94.203.104:8000/actionDetail.php?id=" + id;
            $scope.getCounter($scope.url,$scope);
        };
        ...
        var urlTime = "http://47.94.203.104:8000/actionDetail.php?t=1";
        $http.get(urlTime)
            .success(function(data){
                if(data.length>0){
                    $scope.times=data;
        ...
        $scope.searchStock = function(q){
            ...
            var urlSearch = "http://47.94.203.104:8000/searchStock.php?q=" + q;
            $http.get(urlSearch)
                .success(function (data) {
        ...
        $scope.addInspect = function(q){
            var data = {
             ...
             var urlAdd = "http://47.94.203.104:8000/inspect.php?" + $.param(data);
             $http.get(urlAdd)
                .success(function (data) {
                    $scope.loadInspect();
                    console.log(data);
        ...
        $scope.deleteInspect = function(id){
            ...
            var urlDelete = "http://47.94.203.104:8000/inspect.php?" + $.param(data);
            $http.get(urlDelete)
                .success(function (data) {
                    $scope.loadInspect();
                    console.log(data);
        ...
        $scope.changeTab = function(trans){
            $scope.url = "http://47.94.203.104:8000/" + trans + ".php";
            $scope.getCounter($scope.url,$scope);
        };
        ...
        $scope.changeTime = function(t){
            $scope.url = "http://47.94.203.104:8000/rate.php?t=" + t;
            $scope.getCounter($scope.url,$scope);
        };
        //$scope.changeTime('');
        ...
        $scope.search = {};
        $scope.url = "http://47.94.203.104:8000/holder.php";
        $scope.getCounter($scope.url,$scope);
        ...
        $scope.addHolder = function(code){
            ...
            var urlAdd = "http://47.94.203.104:8000/holder.php?a=a&c=" + code;
            $http.get(urlAdd)
                .success(function (data) {
                    $scope.getCounter($scope.url,$scope);
                });
        ...
        $scope.deleteHolder = function(code){
            var urlDetete = "http://47.94.203.104:8000/holder.php?a=d&c=" + code;
            $http.get(urlDetete)
                .success(function (data) {
                    $scope.getCounter($scope.url,$scope);
        ...
        $scope.url = "http://47.94.203.104:8000/attend.php";
        $scope.getCounter($scope.url,$scope);
        ...
        $scope.deleteAll = function(){
            ...
            var urlAdd = "http://47.94.203.104:8000/attend.php?a=d";
            $http.get(urlAdd)
                .success(function (data) {
                    $scope.getCounter($scope.url,$scope);
                });
        ...
        $scope.url = "http://47.94.203.104:8000/weak.php";
        $scope.getCounter($scope.url,$scope);
        ...
        $scope.addWeak = function(code){
            ...
            var urlAdd = "http://47.94.203.104:8000/weak.php?a=a&c=" + code;
            $http.get(urlAdd)
                .success(function (data) {
                    $scope.getCounter($scope.url,$scope);
                });
        ...
        $scope.deleteAll = function(){
            ...
            var urlAdd = "http://47.94.203.104:8000/weak.php?a=d";
            $http.get(urlAdd)
                .success(function (data) {
                    $scope.getCounter($scope.url,$scope);
                });
        ...
        $scope.deleteAttend = function(code){
            var urlDetete = "http://47.94.203.104:8000/weak.php?a=d&c=" + code;
            $http.get(urlDetete)
                .success(function (data) {
                    $scope.getCounter($scope.url,$scope);
                    //alert('delete successfully.');
    ...
    .controller('ChartCtrl', function ($rootScope,$scope,$interval) {
        ...
        var codes = 'sz002594,sh601390';
                                ...
                                series: {
                                    events: {
                                        legendItemClick: function(event) {
                                            var urlDetete = "http://47.94.203.104:8000/holder.php?a=d&c=" + event.target.name;
                                            $http.get(urlDetete)
                                                .success(function (data) {
                ...
                $scope.getindex = function (code,name) {
                    $http.get('http://47.94.203.104:8000/getindex.php?codes=' + code )
                        .success(function (data) {
                            console.log(data);
                ...
                var getHolder = function () {
                    var url = 'http://47.94.203.104:8000/holder.php';
                    $http.get(url)
                        .success(function (data) {
                            for (var i in data) {
                                var item = data[i];
        ...
        var codes = 'sz002594,sh601390';
                        ...
                        charts[container] = new Highcharts.stockChart({
                            ...
                            plotOptions: {
                                series: {
                                    events: {
                                        legendItemClick: function(event) {
                                            var urlDetete = "http://47.94.203.104:8000/attend.php?a=d&c=" + event.target.name;
                                            $http.get(urlDetete)
                                                .success(function (data) {
                                                    $('div#' + event.target.name).remove();
                                                });
                ...
                var getAttend = function () {
                    // var url = 'http://47.94.203.104:8000/attend.php';
                    // $http.get(url)
                    //     .success(function (data) {
                    //         for (var i in data) {
                    //             var item = data[i];
        ...
        function calPopular(n, time, code) {
            ...
            $http.get('http://47.94.203.104:8000/other/cy.php?' + $.param(p),{timeout: 20000})
                .success(function (data) {
                    console.log(data);
